...
echo'<h1 class="pagehead"> Queries:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3"><tr class="firstrow"><th>Name</th><th>Email</th><th>
Contact number</th><th>Message</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>'. $result['name'] . '</td><td>'.
$result['email'] . '</td><td>' . $result['contactno'] . '</td><td>'.
