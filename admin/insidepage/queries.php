...
echo'<h1 class="pagehead" style="text-align:center; margin-top:5%; font-size:1.95rem; font-weight:bold; font-family:cursive;"> Queries:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3" style="text-align:center;margin-left:20%;margin-right:20%;margin-bottom:5%;font-size:0.8rem;"><tr class="firstrow" ><th>Name</th><th>Email</th><th>
Contact number</th><th>Message</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td class="q">'. $result['name'] . '</td><td class="q">'.
$result['email'] . '</td><td class="q">' . $result['contactno'] . '</td><td class="q">'.
