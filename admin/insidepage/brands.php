...
echo'<h1 class="pagehead" style="text-align:center; margin-top:5%; font-size:1.95rem; font-weight:bold; font-family:cursive;">Brand Details:</h1>';
echo '<table border="1" class="Details" style="text-align:center; margin:auto;margin-bottom:5%;" cellspacing="4" cellpadding="3"><tr class="firstrow"><th>Name</th><th>Creation-Date</th><th>
Updation-Date</th><th>Edit</th><th>Delete</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>'. $result['name'] . '</td><td>'.
$result['Creation Date'] . '</td><td>' . $result['Updation Date'] . '</td><td><a
href="update-brands.php?uid=' . $result['bid'] . ' ">Edit</a></td><td><a
href="deletionbrands.php?uid=' . $result['bid'] . ' ">Delete</a></td></tr>';
}
echo '</table>';
?>
    <!-- Title -->
