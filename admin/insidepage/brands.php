...
echo'<h1 class="pagehead">Brand Details:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3"><tr class="firstrow"><th>Name</th><th>Creation-Date</th><th>
Updation-Date</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>'. $result['name'] . '</td><td>'.
$result['Creation Date'] . '</td><td>' . $result['Updation Date'] . '</td></tr>';
}
echo '</table>';
?>
    <!-- Title -->
