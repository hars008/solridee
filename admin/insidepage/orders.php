...
echo'<h1 class="pagehead">Booking Details:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3"><tr class="firstrow"><th>Booking Date</th><th>Amount Deposited</th><th>
Customer id</th><th>Roll number</th><th>Order id</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>'. $result['date'] . '</td><td>'.
$result['amount'] . '</td><td>' . $result['cid'] . '</td><td>'.
$result['rollnumber'] . '</td><td>' . $result['oid'] .'</td></tr>';
}
echo '</table>';
?>
    <!-- Title -->
