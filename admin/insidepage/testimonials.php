...
echo'<h1 class="pagehead">Testimonials:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3"><tr class="firstrow"><th>Emails</th><th>Testimonials</th></tr>';
