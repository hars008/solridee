...
echo'<h1 class="pagehead" style="text-align:center; margin-top:5%; font-size:1.95rem; font-weight:bold; font-family:cursive;">Testimonials:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3" style="text-align:center; margin:auto;margin-bottom:5%;" ><tr class="firstrow"><th>Emails</th><th>Testimonials</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>'. $result['email'] . '</td><td>'.
$result['testimonials'] . '</td></tr>';
}
echo '</table>';
?>
    <!-- Title -->
