...
echo'<h1 class="pagehead">Reg users Detail:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3"><tr class="firstrow"><th>First Name</th><th>Last name</th><th>
