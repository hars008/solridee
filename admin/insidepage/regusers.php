...
<div class="top">
    ...
    <div class="inside-top">
        <h4>Bike Listing</h4>
        <h6>Dashboard>Registered Users</h6>
    </div>
</div>
</section>
<?php
...
echo'<h1 class="pagehead" style="text-align:center; margin-top:5%; font-size:1.95rem; font-weight:bold; font-family:cursive;">Reg users Detail:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3" style="text-align:center; margin:auto;margin-bottom:5%;" ><tr class="firstrow"><th>First Name</th><th>Last name</th><th>
Roll number</th><th>Mobile number</th><th>Hostel name</th><th>Room number</th><th>Customer id</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>'. $result['firstname'] . '</td><td>'.
$result['lastname'] . '</td><td>' . $result['rollnumber'] . '</td><td>'.
$result['mobilenumber'] . '</td><td>' . $result['hostelname'] .'</td><td>'.
$result['roomnumber'] . '</td><td>' . $result['cid'] .'</td></tr>';
}
echo '</table>';
?>
    <!-- Title -->
