...
echo'<h1 class="pagehead">Subscribers:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3"><tr class="firstrow"><th>Email-id</th><th>Subscription-Date</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>'. $result['emailid'] . '</td><td>'.
$result['subbscriptiondate'] . '</td></tr>';
}
echo '</table>';
?>
    <!-- Title -->
