...
echo'<h1 class="pagehead" style="text-align:center; margin-top:5%; font-size:1.95rem; font-weight:bold; font-family:cursive;" >Cycles Detail:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3" style="text-align:center; margin:auto;margin-bottom:5%;" ><tr class="firstrow"><th>Image</th><th>Cycle id</th><th>Model</th><th>
Brand</th><th>Color</th><th>Type</th><th>Security amount</th><th>Delete</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>';?><img src="../../images/<?php echo $result['image']; ?>" style="height:100px;width:100px;"><?php echo'.</td><td>'.
$result['cycleid'] . '</td><td>'.
$result['model'] . '</td><td>' . $result['brand'] . '</td><td>'.
$result['color'] . '</td><td>' . $result['type'] .'</td><td>'.
$result['security_amt'] . '</td><td><a
href="deletecycle.php?uid=' . $result['cycleid'] . ' ">Delete</a></td></tr>';
}
echo '</table>';
?>
    <!-- Title -->
