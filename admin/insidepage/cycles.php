...
echo'<h1 class="pagehead">Cycles Detail:</h1>';
echo '<table border="1" class="Details" cellspacing="4" cellpadding="3"><tr class="firstrow"><th>Cycle id</th><th>Model</th><th>
Brand</th><th>Color</th><th>Type</th><th>Security amount</th></tr>';
while($result=mysqli_fetch_assoc($res))
{
echo '<tr><td>'. $result['cycleid'] . '</td><td>'.
$result['model'] . '</td><td>' . $result['brand'] . '</td><td>'.
$result['color'] . '</td><td>' . $result['type'] .'</td><td>'.
$result['security_amt'] . '</td></tr>';
}
echo '</table>';
?>
    <!-- Title -->
